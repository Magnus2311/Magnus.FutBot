  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(addProfileAsync.fulfilled, (state, action) => {
        state.status = "idle";
        state.profiles.push(action.payload as unknown as ProfileDTO);
      })
      .addCase(addProfileAsync.rejected, (state) => {
        state.status = "failed";
      })
      ...
      .addCase(getAllProfilesAsync.rejected, (state) => {
        state.status = "failed";
      });
  },
});

export const { add, getAll } = profileSlice.actions;
